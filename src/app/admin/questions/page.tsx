  ...
  return (
    <div className="p-7 flex flex-col gap-6">
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
        <div>
          <h1 style={{ fontSize: "2rem", fontWeight: 700, margin: 0, color: "var(--text)" }}>Question Bank</h1>
          <p style={{ fontSize: "0.95rem", color: "var(--text2)", marginTop: "0.1rem" }}>Manage and organize all questions</p>
        </div>
